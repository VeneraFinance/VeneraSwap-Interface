...
var Icon$_ = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: 32, height: 32, href: "/images/home-box-logo.png" })));
};
...
var Icon$O = function (props) {
    ...
    React.createElement("image", { width: "90", height: "90", href: "/images/quam-price-box.png" })));
};
...
var Icon$p = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", {fill:"#b79adc",   d: "M13.7803 2.71967C14.0732 3.01256 14.0732 3.48744 13.7803 3.78033L12.8107 4.75L14.0307 5.96999H20C21.1 5.96999 22 6.86999 22 7.96999V12.73C21.28 12.25 20.43 11.97 19.5 11.97C17.19 11.97 15.3 13.73 15.05 15.97H11.91C11.96 15.64 12 15.31 12 14.97C12 13.43 11.41 12.03 10.46 10.97H11C12.1 10.97 13 10.07 13 8.96999V7.06068L11.75 5.81066L10.7803 6.78033C10.4874 7.07322 10.0126 7.07322 9.71967 6.78033C9.42678 6.48744 9.42678 6.01256 9.71967 5.71967L12.7197 2.71967C13.0126 2.42678 13.4874 2.42678 13.7803 2.71967Z" }),
...
var Icon$bt = function (props) {
    return (
        React.createElement("img", {src:'/images/boost-ico.png', className:"icon_sidebar" })
    );
    
};
var Icon$doc = function (props) {
    return (
        React.createElement("img", {src:'/images/Icon_Doc.png', className:"icon_sidebar" })
    );
    
};
var Icon$rl = function (props) {
    return (
        React.createElement("img", {src:'/images/referral-ico.png', className:"icon_sidebar" })
    );
...
var Icon$l = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", {fill:"#b79adc", d: "M9.99998 19V14H14V19C14 19.55 14.45 20 15 20H18C18.55 20 19 19.55 19 19V12H20.7C21.16 12 21.38 11.43 21.03 11.13L12.67 3.59997C12.29 3.25997 11.71 3.25997 11.33 3.59997L2.96998 11.13C2.62998 11.43 2.83998 12 3.29998 12H4.99998V19C4.99998 19.55 5.44998 20 5.99998 20H8.99998C9.54998 20 9.99998 19.55 9.99998 19Z" })));
};

var Icon$k = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { fill:"#b79adc", d: "M21.9 8.89L20.85 4.52C20.63 3.62 19.85 3 18.94 3H16.73H14.72H13H11H9.28001H7.26001H5.05001C4.15001 3 3.36001 3.63 3.15001 4.52L2.10001 8.89C1.86001 9.91 2.08001 10.95 2.72001 11.77C2.80001 11.88 2.91001 11.96 3.00001 12.06V19C3.00001 20.1 3.90001 21 5.00001 21H19C20.1 21 21 20.1 21 19V12.06C21.09 11.97 21.2 11.88 21.28 11.78C21.92 10.96 22.15 9.91 21.9 8.89ZM7.02001 5L6.44001 9.86C6.36001 10.51 5.84001 11 5.23001 11C4.74001 11 4.43001 10.71 4.30001 10.53C4.04001 10.2 3.95001 9.77 4.05001 9.36L5.05001 5H7.02001ZM18.91 4.99L19.96 9.36C20.06 9.78 19.97 10.2 19.71 10.53C19.57 10.71 19.27 11 18.77 11C18.16 11 17.63 10.51 17.56 9.86L16.98 5L18.91 4.99ZM15.51 9.52C15.56 9.91 15.44 10.3 15.18 10.59C14.95 10.85 14.63 11 14.22 11C13.55 11 13 10.41 13 9.69V5H14.96L15.51 9.52ZM11 9.69C11 10.41 10.45 11 9.71001 11C9.37001 11 9.06001 10.85 8.82001 10.59C8.57001 10.3 8.45001 9.91 8.49001 9.52L9.04001 5H11V9.69ZM18 19H6.00001C5.45001 19 5.00001 18.55 5.00001 18V12.97C5.08001 12.98 5.15001 13 5.23001 13C6.10001 13 6.89001 12.64 7.47001 12.05C8.07001 12.65 8.87001 13 9.78001 13C10.65 13 11.43 12.64 12.01 12.07C12.6 12.64 13.4 13 14.3 13C15.14 13 15.94 12.65 16.54 12.05C17.12 12.64 17.91 13 18.78 13C18.86 13 18.93 12.98 19.01 12.97V18C19 18.55 18.55 19 18 19Z" })));
};
...
var Logo$2 = function (_a) {
    ...
    var textColor = isDark ? "#c9c4d4" : "#000000";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 205 46" }, props),
         React.createElement("image", { width: "205", height: "46", href: "/images/logo-with-text.png" })));
};
...
var Icon$g = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", {fill:"#b79adc", d: "M6 10C4.9 10 4 10.9 4 12C4 13.1 4.9 14 6 14C7.1 14 8 13.1 8 12C8 10.9 7.1 10 6 10ZM18 10C16.9 10 16 10.9 16 12C16 13.1 16.9 14 18 14C19.1 14 20 13.1 20 12C20 10.9 19.1 10 18 10ZM12 10C10.9 10 10 10.9 10 12C10 13.1 10.9 14 12 14C13.1 14 14 13.1 14 12C14 10.9 13.1 10 12 10Z" })));
};
...
var Icon$8 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", {fill:"#b79adc",   fillRule: "evenodd", clipRule: "evenodd", d: "M18.86 4.86003L21.65 7.65003C21.84 7.84003 21.84 8.16003 21.64 8.35003L18.85 11.14C18.54 11.46 18 11.24 18 10.79V9.00003H4C3.45 9.00003 3 8.55003 3 8.00003C3 7.45003 3.45 7.00003 4 7.00003H18V5.21003C18 4.76003 18.54 4.54003 18.86 4.86003ZM5.14001 19.14L2.35001 16.35C2.16001 16.16 2.16001 15.84 2.36001 15.65L5.15001 12.86C5.46001 12.54 6.00001 12.76 6.00001 13.21V15H20C20.55 15 21 15.45 21 16C21 16.55 20.55 17 20 17H6.00001V18.79C6.00001 19.24 5.46001 19.46 5.14001 19.14Z" })));
};

var Icon$7 = function (props) {
    return (
        React.createElement("img", {src:'/images/icon_twitter.png', className:"icon_sidebar" })
    );
    // return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$md = function (props) {
    return (
        React.createElement("img", {src:'/images/icon_medium.png', className:"icon_sidebar" })
    );
};

var Icon$gb = function (props) {
    return (
        React.createElement("img", {src:'/images/icon_gitbook.png', className:"icon_sidebar" })
    );
};
var Icon$rt = function (props) {
    return (
        React.createElement("img", {src:'/images/icon_reddit.png', className:"icon_sidebar" })
    );
};
...
var socials = [
    {
        label: "Gitbook",
        icon: "GitbookIcon",
        href: "https://discord.gg/QsUQ9D3exJ",       
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/VeneraSwap",
    },
    {
        label: "Medium",
        icon: "MediumIcon",
        href: "https://medium.com/@VeneraSwap",
    },
   
    {
        label: "Telegram",
        icon: "RedditIcon",
        href: "https://t.me/VeneraSwap",       
    },
    {
        label: "Doc",
        icon: "DocIcon",
        href: "http://docs.veneraswap.com/",       
    },
];
var MENU_HEIGHT = 64;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "transparent", backgroundDisabled: "#222e37", contrast: "#c9c4d4", dropdown: "#1E1D20", invertedContrast: "#9e9e9e26", input: "#9e9e9e26", inputSecondary: "#66578D", primaryDark: "#0098A1", tertiary: "#9e9e9e26", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#fff", borderColor: "#524B63", card: "#133444", gradients: {
    bubblegum: "linear-gradient(139.73deg, #313D5C 0%, #3D2A54 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "transparent", backgroundDisabled: "#222e37", contrast: "#c9c4d4", dropdown: "#1E1D20", invertedContrast: "#9e9e9e26", input: "#9e9e9e26", inputSecondary: "#66578D", primaryDark: "#0098A1", tertiary: "#9e9e9e26", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#fff", borderColor: "#524B63", card: "linear-gradient(100deg,#0b293e 25%,#2d3142 91%,#2a3042 85%)", gradients: {
        bubblegum: "linear-gradient(139.73deg, #313D5C 0%, #3D2A54 100%)",
    } });
