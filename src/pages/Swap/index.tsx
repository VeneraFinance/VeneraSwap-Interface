...
const Swap = () => {
  ...
  return (
    <>
      ...
      <CardNav />
       <div className="shadowBorder bordboxout">
      <AppBody>
       
        <Wrapper id="swap-page" className="swap_page_icon">
          <ConfirmSwapModal
            isOpen={showConfirm}
            trade={trade}
          ...
          <CardBody>
              ...
              <AutoColumn justify="space-between">
                <AutoRow justify={isExpertMode ? 'space-between' : 'center'} style={{ padding: '0 1rem' }}>
                  <ArrowWrapper clickable>
                    <IconButton className="arr_down_btn"
                      variant="tertiary"
                      onClick={() => {
                        setApprovalSubmitted(false) // reset 2 step UI for approvals
                        onSwitchTokens()
            ...
            <BottomGrouping>
              {!account ? (
                ...
                <Button className="btn_yellow" disabled={Boolean(wrapInputError)} onClick={onWrap} width="100%">
                  {wrapInputError ??
